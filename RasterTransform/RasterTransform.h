...
#define TRANSFORM_X_TILES_MIN      FALSE
#define TRANSFORM_X_TILES_MAX      TRUE
#define TRANSFORM_X_TILES_DFLT     FALSE

#define TRANSFORM_Y_TILES_MIN      FALSE
#define TRANSFORM_Y_TILES_MAX      TRUE
#define TRANSFORM_Y_TILES_DFLT     FALSE

#define TRANSFORM_MIRROR_MIN       FALSE
#define TRANSFORM_MIRROR_MAX       TRUE
#define TRANSFORM_MIRROR_DFLT      FALSE
...
enum {
    ...
    TRANSFORM_FILL,
    TRANSFORM_SAMPLE,
    TRANSFORM_TILES_GROUP_START,
    TRANSFORM_X_TILES,
    TRANSFORM_Y_TILES,
    TRANSFORM_MIRROR,
    TRANSFORM_TILES_GROUP_END,
