    ...
    PixelType* outP)
{
    ...
    if (params) {
        ...
        float centerX = width / 2.0f + params->positionX;
        float centerY = height / 2.0f - params->positionY;
        ...
        float sample_x = xL + ((dx - 0.5f) * params->magnitude * width);
        float sample_y = yL - ((dy - 0.5f) * params->magnitude * height);
