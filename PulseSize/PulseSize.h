...
typedef struct PulseSizeInfo {
    ...
    PF_Boolean y_tiles;
    PF_Boolean mirror;
    PF_Boolean normal_enabled;
    PF_Boolean compatibility_enabled;
    PF_FpLong compat_frequency;
    PF_FpLong compat_shrink;
    PF_FpLong compat_grow;
    PF_FpLong compat_phase;
